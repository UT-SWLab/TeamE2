...
class CircuitModelGUITest(unittest.TestCase):
    def test_pagination_nextpage_circuit(self):
        ...
        driver.get("https://f1stat-292509.uc.r.appspot.com/models_circuits")
        nextPage = driver.find_element_by_css_selector("[aria-label='Next']")
        nextPage.click()
        self.assertEqual(driver.current_url, 'https://f1stat-292509.uc.r.appspot.com/models_circuits?page=2')
    
    def test_pagination_prevpage_circuit(self):
        driver = webdriver.Chrome(executable_path=r".\chromedriver.exe")
        driver.get("https://f1stat-292509.uc.r.appspot.com/models_circuits?page=2")
        prevPage = driver.find_element_by_css_selector("[aria-label='Previous']")
        prevPage.click()
        self.assertEqual(driver.current_url, 'https://f1stat-292509.uc.r.appspot.com/models_circuits?page=1')
